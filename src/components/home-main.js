            ...
            <section className="Home_main__OVLM4" data-scroll-container ref={containerRef}>
                ...
                <section className="home_about" data-scroll-section >
                    <div className="container">
                        <h2 className="title">Crafting Digital Magic in the Heart of Los Angeles: Where Web Design Meets Innovation</h2>
                        <p className="ptitle">I design, build and optimise bespoke Shopify Plus, Laravel, WordPress solutions to elevate and grow your business. </p>
                    </div>
                    <div data-scroll data-scroll-speed="4" >
                        <img title="image-intro1" alt="" width="294" height="308" nitro-lazy-src="https://images.pexels.com/photos/2181230/pexels-photo-2181230.jpeg" className="img-fluid lazyloaded" decoding="async" nitro-lazy-empty="" id="MzY2OjE2OA==-1" src="https://images.pexels.com/photos/2181230/pexels-photo-2181230.jpeg">
                        </img>
                    </div>
                </section>
                        ...
                        <div className="row">
                            <div data-scroll="" className="">
                                <div data-scroll="" className="cfadeinup-inner-hero ">
                                    <h2 className="hero-heading gradient-title5">Developer/Designer</h2>
                                </div>
                                <div data-scroll="" className="cfadeinup-inner-sub ">
                                    <h3 className="h2">Skilled Developer, Strategic Thinker, and a quick learner</h3>
                                </div>
                            ...
                            <div className="stats-block " data-scroll data-scroll-speed="4">
                                ...
                                <div className="statistics">
                                    ...
                                    <span className="body-large d-block">Websites &amp; projects launched</span>
                                </div>
                ...
                <section className="home_skillset" data-scroll-section>
                    <div className="container">
                        ...
                        <div data-scroll="" className="hover-reveal-effect canvas-reveal cfadeinup is-inview" data-src="/ChEvwayTHZmZJUAdsUNMLXuXZdBprFoQ/assets/images/optimized/rev-21ec0b7/www.aaaaa.com/app/uploads/2022/09/image-abouthover-1.jpg">
                            <div className="row hover-row">
                                <div className="col-xl-5 col-lg-6 desc-title">
                                    <h3 className="h2">Longevity</h3>
                                </div>
                                <div className="col-xl-5 col-lg-6 desc-text"> <span>
                                    As a web developer, I've been proudly serving the Los Angeles community for nearly a decade, offering exceptional web development services with a personal touch.
                                </span>
                                </div>
                            </div>
                        </div>
                        <div data-scroll="" className="hover-reveal-effect canvas-reveal cfadeinup is-inview" data-src="/ChEvwayTHZmZJUAdsUNMLXuXZdBprFoQ/assets/images/optimized/rev-21ec0b7/www.aaaaa.com/app/uploads/2022/09/image-abouthover-2.jpg">
                            <div className="row hover-row">
                                <div className="col-xl-5 col-lg-6 desc-title">
                        ...
                        <div data-scroll="" className="hover-reveal-effect canvas-reveal cfadeinup is-inview" data-src="/ChEvwayTHZmZJUAdsUNMLXuXZdBprFoQ/assets/images/optimized/rev-21ec0b7/www.aaaaa.com/app/uploads/2022/09/image-abouthover-3.jpg">
                            <div className="row hover-row">
                                <div className="col-xl-5 col-lg-6 desc-title">
                        ...
                        <div data-scroll="" className="hover-reveal-effect canvas-reveal cfadeinup is-inview" data-src="/ChEvwayTHZmZJUAdsUNMLXuXZdBprFoQ/assets/images/optimized/rev-21ec0b7/www.aaaaa.com/app/uploads/2022/09/image-abouthover-4.jpg">
                            <div className="row hover-row">
                                <div className="col-xl-5 col-lg-6 desc-title">
                        ...
                        <div data-scroll="" className="hover-reveal-effect canvas-reveal cfadeinup is-inview" data-src="/ChEvwayTHZmZJUAdsUNMLXuXZdBprFoQ/assets/images/optimized/rev-21ec0b7/www.aaaaa.com/app/uploads/2022/09/image-abouthover-5.jpg">
                            <div className="row hover-row">
                                <div className="col-xl-5 col-lg-6 desc-title">
                        ...
                        <div data-scroll="" className="hover-reveal-effect canvas-reveal cfadeinup is-inview" data-src="/ChEvwayTHZmZJUAdsUNMLXuXZdBprFoQ/assets/images/optimized/rev-21ec0b7/www.aaaaa.com/app/uploads/2022/09/image-abouthover-6-1.jpg">
                            <div className="row hover-row">
                                <div className="col-xl-5 col-lg-6 desc-title">
                ...
                <section className="project-output" data-scroll-section>
                    <div className="container">
                        ...
                        <div className="item">
                            <a href="">
                                <img src="https://cdn.worldvectorlogo.com/logos/google-pagespeed-insights-icon-2021-.svg" alt="" />
                            </a>
                        </div>
                        <div className="item">
                            <a href="">
                ...
                <section className="hp-client-wrap client-wrap technologies-logos nitro-offscreen nitro-lazy-render"
    data-scroll-section="" data-scroll-section-id="section9" data-scroll-section-inview="">
    <div className="client-title">
        <div className="container">
            <h3 data-scroll="" className="cfadeinup-inner-hero h1 gradient-title9 ">We are experts in leading
                industry standard platforms &amp; technologies.</h3>
        </div>
    </div>
    <div className="client-section client-label">
                <div className="client-slider">
                    <div className="d-flex client-slide"  data-scroll="" data-scroll-direction="horizontal"
                        data-scroll-speed="3"
                        >
                        <div className="client-block d-flex justify-content-center align-items-center flex-column">
                            <span className="img-wrapper">
                                <img title="client-magento" height="80" width="62" alt="Magento"
                                    className="lazyloaded" decoding="async" nitro-lazy-empty="" id="OTI3OjE5NA==-1"
                                    src="https://cdn-eahjn.nitrocdn.com/ChEvwayTHZmZJUAdsUNMLXuXZdBprFoQ/assets/images/optimized/rev-82d6b35/www.spinxdigital.com/app/uploads/2022/09/client-magento.svg"></img></span>
                            <span className="d-block">Magento</span>
                        </div>
                        <div className="client-block d-flex justify-content-center align-items-center flex-column">
                            <span className="img-wrapper">
                                <img title="icon-wordpress" height="80" width="62" alt="Wordpress"
                                    className="lazyloaded" decoding="async" nitro-lazy-empty="" id="OTMxOjE5Ng==-1"
                                    src="https://cdn-eahjn.nitrocdn.com/ChEvwayTHZmZJUAdsUNMLXuXZdBprFoQ/assets/images/optimized/rev-82d6b35/www.spinxdigital.com/app/uploads/2022/09/icon-wordpress.svg"></img></span>
                            <span className="d-block">Wordpress</span>
                        </div>
                        <div className="client-block d-flex justify-content-center align-items-center flex-column">
                            <span className="img-wrapper">
                                <img title="icon-shopify" height="80" width="62" alt="Shopify"
                                    className="lazyloaded" decoding="async" nitro-lazy-empty="" id="OTM1OjE5MA==-1"
                                    src="https://cdn-eahjn.nitrocdn.com/ChEvwayTHZmZJUAdsUNMLXuXZdBprFoQ/assets/images/optimized/rev-82d6b35/www.spinxdigital.com/app/uploads/2022/09/icon-shopify.svg"></img></span>
                            <span className="d-block">Shopify</span>
                        </div>
                        <div className="client-block d-flex justify-content-center align-items-center flex-column">
                            <span className="img-wrapper">
                                <img title="icon-umbraco" height="80" width="62" alt="Umbraco"
                                    className="lazyloaded" decoding="async" nitro-lazy-empty="" id="OTM5OjE5MA==-1"
                                    src="https://cdn-eahjn.nitrocdn.com/ChEvwayTHZmZJUAdsUNMLXuXZdBprFoQ/assets/images/optimized/rev-82d6b35/www.spinxdigital.com/app/uploads/2023/01/icon-umbraco.svg"></img></span>
                            <span className="d-block">Umbraco</span>
                        </div>
                        <div className="client-block d-flex justify-content-center align-items-center flex-column">
                            <span className="img-wrapper">
                                <img title="microsoft-net" height="80" width="62" alt="Microsoft .NET"
                                    className="lazyloaded" decoding="async" nitro-lazy-empty="" id="OTQzOjE5OQ==-1"
                                    src="https://cdn-eahjn.nitrocdn.com/ChEvwayTHZmZJUAdsUNMLXuXZdBprFoQ/assets/images/optimized/rev-82d6b35/www.spinxdigital.com/app/uploads/2022/09/microsoft-net.svg"></img></span>
                            <span className="d-block">Microsoft .NET</span>
                        </div>
                        <div className="client-block d-flex justify-content-center align-items-center flex-column">
                            <span className="img-wrapper">
                                <img title="Property 1=Sitefinity" height="80" width="62" alt="Progress Sitefinity"
                                    className="lazyloaded" decoding="async" nitro-lazy-empty=""
                                    id="OTQ3OjIy</img>MQ==-1"
                                    src="https://cdn-eahjn.nitrocdn.com/ChEvwayTHZmZJUAdsUNMLXuXZdBprFoQ/assets/images/optimized/rev-82d6b35/www.spinxdigital.com/app/uploads/2023/01/Property-1Sitefinity-2.svg"></img></span>
                            <span className="d-block">Progress Sitefinity</span>
                        </div>
                        <div className="client-block d-flex justify-content-center align-items-center flex-column">
                            <span className="img-wrapper">
                                <img title="client-magento" height="80" width="62" alt="Magento"
                                    className="lazyloaded" decoding="async" nitro-lazy-empty="" id="OTUxOjE5NA==-1"
                                    src="https://cdn-eahjn.nitrocdn.com/ChEvwayTHZmZJUAdsUNMLXuXZdBprFoQ/assets/images/optimized/rev-82d6b35/www.spinxdigital.com/app/uploads/2022/09/client-magento.svg"></img></span>
                            <span className="d-block">Magento</span>
                        </div>
                        <div className="client-block d-flex justify-content-center align-items-center flex-column">
                            <span className="img-wrapper">
                                <img title="icon-wordpress" height="80" width="62" alt="Wordpress"
                                    className="nitro-lazy" decoding="async" nitro-lazy-empty="" id="OTU1OjE5Ng==-1"
                                    src="data:image/svg+xml;nitro-empty-id=OTU1OjE5Ng==-1;base64,PHN2ZyB2aWV3Qm94PSIwIDAgODMgODMiIHdpZHRoPSI4MyIgaGVpZ2h0PSI4MyIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48L3N2Zz4="></img></span>
                            <span className="d-block">Wordpress</span>
                        </div>
                        <div className="client-block d-flex justify-content-center align-items-center flex-column">
                            <span className="img-wrapper">
                                <img title="icon-shopify" height="80" width="62" alt="Shopify"
                                    className="nitro-lazy" decoding="async" nitro-lazy-empty="" id="OTU5OjE5MA==-1"
                                    src="data:image/svg+xml;nitro-empty-id=OTU5OjE5MA==-1;base64,PHN2ZyB2aWV3Qm94PSIwIDAgNzggODciIHdpZHRoPSI3OCIgaGVpZ2h0PSI4NyIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48L3N2Zz4="></img></span>
                            <span className="d-block">Shopify</span>
                        </div>
                        <div className="client-block d-flex justify-content-center align-items-center flex-column">
                            <span className="img-wrapper">
                                <img title="icon-umbraco" height="80" width="62" alt="Umbraco"
                                    className="nitro-lazy" decoding="async" nitro-lazy-empty="" id="OTYzOjE5MA==-1"
                                    src="data:image/svg+xml;nitro-empty-id=OTYzOjE5MA==-1;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMTY0IDE2NiIgd2lkdGg9IjE2NCIgaGVpZ2h0PSIxNjYiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PC9zdmc+"></img></span>
                            <span className="d-block">Umbraco</span>
                        </div>
                        <div className="client-block d-flex justify-content-center align-items-center flex-column">
                            <span className="img-wrapper">
                                <img title="microsoft-net" height="80" width="62" alt="Microsoft .NET"
                                    className="nitro-lazy" decoding="async" nitro-lazy-empty="" id="OTY3OjE5OQ==-1"
                                    src="data:image/svg+xml;nitro-empty-id=OTY3OjE5OQ==-1;base64,PHN2ZyB2aWV3Qm94PSIwIDAgNzggNzciIHdpZHRoPSI3OCIgaGVpZ2h0PSI3NyIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48L3N2Zz4="></img></span>
                            <span className="d-block">Microsoft .NET</span>
                        </div>
                        <div className="client-block d-flex justify-content-center align-items-center flex-column">
                            <span className="img-wrapper">
                                <img title="Property 1=Sitefinity" height="80" width="62" alt="Progress Sitefinity"
                                    className="nitro-lazy" decoding="async" nitro-lazy-empty=""
                                    id="OTcxOjIy</img>MQ==-1"
                                    src="data:image/svg+xml;nitro-empty-id=OTcxOjIyMQ==-1;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMTAwIDEwMCIgd2lkdGg9IjEwMCIgaGVpZ2h0PSIxMDAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PC9zdmc+"></img></span>
                            <span className="d-block">Progress Sitefinity</span>
                        </div>
                    </div>
                </div>
        ...
        <div className="client-section dark-bg client-label">
            <div className="client-slider">
                <div className="d-flex client-slide"  data-scroll="" data-scroll-direction="horizontal"
                    data-scroll-speed="-3"
                    >
                    <div className="client-block d-flex justify-content-center align-items-center flex-column"> <span
                            className="img-wrapper">
                            <img title="Shape" height="80" width="62" alt="Drupal"
                                className="lazyloaded" decoding="async" nitro-lazy-empty="" id="OTgxOjE3NQ==-1"
                                src="https://cdn-eahjn.nitrocdn.com/ChEvwayTHZmZJUAdsUNMLXuXZdBprFoQ/assets/images/optimized/rev-82d6b35/www.spinxdigital.com/app/uploads/2023/01/Shape.png"></img></span>
                        <span className="d-block">Drupal</span>
                    </div>
                    <div className="client-block d-flex justify-content-center align-items-center flex-column"> <span
                            className="img-wrapper">
                            <img title="icon-sitecore" height="80" width="62" alt="Sitecore"
                                className="lazyloaded" decoding="async" nitro-lazy-empty="" id="OTg1OjE5Mw==-1"
                                src="https://cdn-eahjn.nitrocdn.com/ChEvwayTHZmZJUAdsUNMLXuXZdBprFoQ/assets/images/optimized/rev-82d6b35/www.spinxdigital.com/app/uploads/2022/09/icon-sitecore.svg"></img></span>
                        <span className="d-block">Sitecore</span>
                    </div>
                    <div className="client-block d-flex justify-content-center align-items-center flex-column"> <span
                            className="img-wrapper">
                            <img title="icon-kentico" height="80" width="62" alt="Kentico"
                                className="lazyloaded" decoding="async" nitro-lazy-empty="" id="OTg5OjE5MA==-1"
                                src="https://cdn-eahjn.nitrocdn.com/ChEvwayTHZmZJUAdsUNMLXuXZdBprFoQ/assets/images/optimized/rev-82d6b35/www.spinxdigital.com/app/uploads/2022/09/icon-kentico.svg"></img></span>
                        <span className="d-block">Kentico</span>
                    </div>
                    <div className="client-block d-flex justify-content-center align-items-center flex-column"> <span
                            className="img-wrapper">
                            <img title="icon-react" height="80" width="62" alt="React JS"
                                className="lazyloaded" decoding="async" nitro-lazy-empty="" id="OTkzOjE4Nw==-1"
                                src="https://cdn-eahjn.nitrocdn.com/ChEvwayTHZmZJUAdsUNMLXuXZdBprFoQ/assets/images/optimized/rev-82d6b35/www.spinxdigital.com/app/uploads/2022/09/icon-react.svg"></img></span>
                        <span className="d-block">React JS</span>
                    </div>
                    <div className="client-block d-flex justify-content-center align-items-center flex-column"> <span
                            className="img-wrapper">
                            <img title="icon-apple" height="80" width="62" alt="Apple iOS"
                                className="lazyloaded" decoding="async" nitro-lazy-empty="" id="OTk3OjE4OA==-1"
                                src="https://cdn-eahjn.nitrocdn.com/ChEvwayTHZmZJUAdsUNMLXuXZdBprFoQ/assets/images/optimized/rev-82d6b35/www.spinxdigital.com/app/uploads/2022/09/icon-apple.svg"></img></span>
                        <span className="d-block">Apple iOS</span>
                    </div>
                    <div className="client-block d-flex justify-content-center align-items-center flex-column"> <span
                            className="img-wrapper">
                            <img title="icon-android" height="80" width="62" alt="Android"
                                className="lazyloaded" decoding="async" nitro-lazy-empty="" id="MTAwMToxOTA=-1"
                                src="https://cdn-eahjn.nitrocdn.com/ChEvwayTHZmZJUAdsUNMLXuXZdBprFoQ/assets/images/optimized/rev-82d6b35/www.spinxdigital.com/app/uploads/2022/09/icon-android.svg"></img></span>
                        <span className="d-block">Android</span>
                    </div>
                    <div className="client-block d-flex justify-content-center align-items-center flex-column"> <span
                            className="img-wrapper">
                            <img title="Shape" height="80" width="62" alt="Drupal"
                                className="lazyloaded" decoding="async" nitro-lazy-empty="" id="MTAwNToxNzU=-1"
                                src="https://cdn-eahjn.nitrocdn.com/ChEvwayTHZmZJUAdsUNMLXuXZdBprFoQ/assets/images/optimized/rev-82d6b35/www.spinxdigital.com/app/uploads/2023/01/Shape.png"></img></span>
                        <span className="d-block">Drupal</span>
                    </div>
                    <div className="client-block d-flex justify-content-center align-items-center flex-column"> <span
                            className="img-wrapper">
                            <img title="icon-sitecore" height="80" width="62" alt="Sitecore"
                                className="nitro-lazy" decoding="async" nitro-lazy-empty="" id="MTAwOToxOTM=-1"
                                src="data:image/svg+xml;nitro-empty-id=MTAwOToxOTM=-1;base64,PHN2ZyB2aWV3Qm94PSIwIDAgODMgODMiIHdpZHRoPSI4MyIgaGVpZ2h0PSI4MyIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48L3N2Zz4="></img></span>
                        <span className="d-block">Sitecore</span>
                    </div>
                    <div className="client-block d-flex justify-content-center align-items-center flex-column"> <span
                            className="img-wrapper">
                            <img title="icon-kentico" height="80" width="62" alt="Kentico"
                                className="nitro-lazy" decoding="async" nitro-lazy-empty="" id="MTAxMzoxOTA=-1"
                                src="data:image/svg+xml;nitro-empty-id=MTAxMzoxOTA=-1;base64,PHN2ZyB2aWV3Qm94PSIwIDAgODMgODMiIHdpZHRoPSI4MyIgaGVpZ2h0PSI4MyIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48L3N2Zz4="></img></span>
                        <span className="d-block">Kentico</span>
                    </div>
                    <div className="client-block d-flex justify-content-center align-items-center flex-column"> <span
                            className="img-wrapper">
                            <img title="icon-react" height="80" width="62" alt="React JS"
                                className="nitro-lazy" decoding="async" nitro-lazy-empty="" id="MTAxNzoxODc=-1"
                                src="data:image/svg+xml;nitro-empty-id=MTAxNzoxODc=-1;base64,PHN2ZyB2aWV3Qm94PSIwIDAgODcgNzciIHdpZHRoPSI4NyIgaGVpZ2h0PSI3NyIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48L3N2Zz4="></img></span>
                        <span className="d-block">React JS</span>
                    </div>
                    <div className="client-block d-flex justify-content-center align-items-center flex-column"> <span
                            className="img-wrapper">
                            <img title="icon-apple" height="80" width="62" alt="Apple iOS"
                                className="nitro-lazy" decoding="async" nitro-lazy-empty="" id="MTAyMToxODg=-1"
                                src="data:image/svg+xml;nitro-empty-id=MTAyMToxODg=-1;base64,PHN2ZyB2aWV3Qm94PSIwIDAgNzAgODMiIHdpZHRoPSI3MCIgaGVpZ2h0PSI4MyIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48L3N2Zz4="></img></span>
                        <span className="d-block">Apple iOS</span>
                    </div>
                    <div className="client-block d-flex justify-content-center align-items-center flex-column"> <span
                            className="img-wrapper">
                            <img title="icon-android" height="80" width="62" alt="Android"
                                className="nitro-lazy" decoding="async" nitro-lazy-empty="" id="MTAyNToxOTA=-1"
                                src="data:image/svg+xml;nitro-empty-id=MTAyNToxOTA=-1;base64,PHN2ZyB2aWV3Qm94PSIwIDAgODUgNDgiIHdpZHRoPSI4NSIgaGVpZ2h0PSI0OCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48L3N2Zz4="></img></span>
                        <span className="d-block">Android</span>
                    </div>
                </div>
            </div>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-10 col-xl-6 client-wrap-heading">
                        <p>We've spent almost 2 decades in web design, and have crafted creative web design solutions
                            using
                            a wide variety of platforms.</p> <a
                            href="https://www.spinxdigital.com/enterprise-cms-solutions/"
                            className="btn-link btn-link-white">Which platform is right for you?</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="info_col" id="featured_2">
                                    <div data-scroll="" data-scroll-sticky="" data-scroll-target="#featured_2" className="casestudy-title">
                                        <span>seed.com</span>
                ...
                <section className="home_look" data-scroll-section>
                    <div className="container">
                        <div className="row align-items-center">
                            <div className="col-lg-5 mb-5 mb-lg-0 home_look_image" data-scroll="" data-scroll-speed="5">
                                <img alt="" width="522" height="560"
                                    className="img-fluid lazyloaded"
                                    src="images/dpc.jpg"></img>
                            </div>
                            <div className="col-lg-7">
                                ...
                                <a href="https://www.aaaaa.com/start-a-project/" className="btn btn-primary">Contact Us</a>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="home_services" data-scroll-section>
                    <div className="container">
                        <h2 className="title">Ambitious. Beautiful. Creative. Technical. Services</h2>
                        <div className="services">
                            <div className="item">
                                <h3 className="title"><span>ADA Compliance</span></h3>
                            ...
                            <div className="item">
                                <h3 className="title"><span>Speed Optimisation</span></h3>
                            ...
                            <div className="item">
                                <h3 className="title"><span>Website Design</span></h3>
                                <p>With our eCommerce agency's expert CRO insights and recommendations, we’ll help you supercharge your site and elevate your brand on Shopify Plus. </p>
                            </div>
                            <div className="item">
                                <h3 className="title"><span>Website Development</span></h3>
                                <p>With our eCommerce agency's expert CRO insights and recommendations, we’ll help you supercharge your site and elevate your brand on Shopify Plus. </p>
                            </div>
                            <div className="item">
                                <h3 className="title"><span>Enterprise CMS Solutions</span></h3>
                                <p>With our eCommerce agency's expert CRO insights and recommendations, we’ll help you supercharge your site and elevate your brand on Shopify Plus. </p>
                            </div>
                            <div className="item">
                                <h3 className="title"><span>Website Redesign Services</span></h3>
                                <p>With our eCommerce agency's expert CRO insights and recommendations, we’ll help you supercharge your site and elevate your brand on Shopify Plus. </p>
                            </div>
                            <div className="item">
                                <h3 className="title"><span>Website Maintenance Services</span></h3>
                                <p>With our eCommerce agency's expert CRO insights and recommendations, we’ll help you supercharge your site and elevate your brand on Shopify Plus. </p>
                            </div>
                            <div className="item">
                                <h3 className="title"><span>Search Engine Optimization</span></h3>
                                <p>With our eCommerce agency's expert CRO insights and recommendations, we’ll help you supercharge your site and elevate your brand on Shopify Plus. </p>
                            </div>
                        </div>
                    </div>
